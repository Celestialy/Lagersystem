        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Barocde = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsumptionItems_Inventories_InventoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoanItems_Inventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "Inventories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LoanItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsumptionItems_DepartmentId",
                table: "ConsumptionItems",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ConsumptionItems_InventoryId",
                table: "ConsumptionItems",
                column: "InventoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanItems_DepartmentId",
                table: "LoanItems",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_LoanItems_InventoryId",
                table: "LoanItems",
                column: "InventoryId");

            migrationBuilder.CreateIndex(
                name: "IX_LoanItems_ItemId",
                table: "LoanItems",
                column: "ItemId");
        }
